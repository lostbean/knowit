...
RUN HF_CACHE_ONLY="true" MIX_ENV="CI" mix deps.get
RUN HF_CACHE_ONLY="true" MIX_ENV="CI" mix deps.compile
RUN HF_CACHE_ONLY="true" MIX_ENV="CI" mix run -e 'Knowit.Serving.AudioToText.serving()'
