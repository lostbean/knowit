defmodule KnowitWeb.Router do
  ...
  scope "/", KnowitWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{KnowitWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", KnowitWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{KnowitWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", KnowitWeb do
    ...
    live_session :current_user,
      on_mount: [{KnowitWeb.UserAuth, :mount_current_user}] do
